    ...
    >
      ...
      <div className="max-w-[760px] mx-auto px-6">
        <div className="flex flex-col md:flex-row justify-center items-start gap-[60px]">
          ...
          <div className="max-w-[260px]">
            ...
            <p className="text-[14px] leading-[1.8] text-white/85 mb-6">
              VAT: {identity.vat_number || "BE 0742576075"}
            </p>

            <a
              href={`mailto:${contact.email}`}
              className="block text-[14px] leading-[1.8] text-white/85 hover:text-white transition-colors"
            >
      ...
      <div className="mt-[85px] px-[50px] lg:px-[65px]">
        <div className="flex flex-col md:flex-row justify-between items-center gap-5">
          <div className="text-[13px] font-bold tracking-[0.14em] uppercase text-white">
